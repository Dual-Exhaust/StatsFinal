						...
						try {
							...
							case "3.2":
								image.setIcon(null /*
													 ...
													 * File(StatsGraphs.getChapterThreeTwo())))
													 */);
							...
							case "3.4":
								image.setIcon(null /*
													 * new ImageIcon(ImageIO.read(new
													 * File(StatsGraphs.getChapterThreeFour())))
													 */);
							...
							case "3.5":
								image.setIcon(null /*
													 * new ImageIcon(ImageIO.read(new
													 * File(StatsGraphs.getChapterThreeFive())))
													 */);
							...
							case "3.9":
								image.setIcon(
										null/*
											 * new ImageIcon(ImageIO.read(new File(StatsGraphs.getChapterThreeNine())))
											 */);
								text.setText(Info.getChapterThreeNine());
								break;
							case "3.10":
								image.setIcon(
										null/*
											 * new ImageIcon(ImageIO.read(new File(StatsGraphs.getChapterThreeTen())))
											 */);
								text.setText(Info.getChapterThreeTen());
								break;
							case "3.11":
								image.setIcon(null/*
													 * new ImageIcon(ImageIO.read(new
													 * File(StatsGraphs.getChapterThreeEleven())))
													 */);
